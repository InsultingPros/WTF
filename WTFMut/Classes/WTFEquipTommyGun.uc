class WTFEquipTommyGun extends ThompsonSMG
	config(user);
...
var WTFEquipTommyGunFmA MyFm;

simulated function PostBeginPlay()
{
	Super.PostBeginPlay();
	MyFm = WTFEquipTommyGunFmA(FireMode[0]);
}
...
defaultproperties
{
	FireModeClass(0)=Class'WTF.WTFEquipTommyGunFmA'
	Description="WTF Commando: toggle to Super Auto"
	PickupClass=Class'WTF.WTFEquipTommyGunPickup'
	ItemName="Tommy Gun"
}