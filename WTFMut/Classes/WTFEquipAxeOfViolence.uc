class WTFEquipAxeOfViolence extends Axe;
...
defaultproperties
{
	FireModeClass(0)=Class'WTF.WTFEquipAxeOfViolenceFmA'
	FireModeClass(1)=Class'WTF.WTFEquipAxeOfViolenceFmB'
	Description="WTF Berserker: attacks do not slow you, iron-sights to lunge, hold secondary to charge or release while falling."
	PickupClass=Class'WTF.WTFEquipAxeOfViolencePickup'
	ItemName="Axe Of Violence"
}
