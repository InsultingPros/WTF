...
var WTFEquipBulldogFmA MyFm;

simulated function PostBeginPlay()
{
	Super.PostBeginPlay();
	MyFm = WTFEquipBulldogFmA(FireMode[0]);
}
...
defaultproperties
{
	FireModeClass(0)=Class'WTF.WTFEquipBulldogFmA'
	Description="WTF Commando: can toggle to Super Auto"
