class WTFEquipFnWin extends FNFAL_ACOG_AssaultRifle
	config(user);

var bool IsWTFCommando;
var WTFEquipFnWinFmA MyFm;

simulated function PostBeginPlay()
{
	Super.PostBeginPlay();
	MyFm = WTFEquipFnWinFmA(FireMode[0]);
}
...
defaultproperties
{
	FireModeClass(0)=Class'WTF.WTFEquipFNWinFmA'
	Description="WTF Commando: toggle to Super Auto"
	PickupClass=Class'WTF.WTFEquipFNWinPickup'
	ItemName="FnWin"
}