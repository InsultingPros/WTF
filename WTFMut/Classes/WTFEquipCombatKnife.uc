class WTFEquipCombatKnife extends Knife;
...
defaultproperties
{
	FireModeClass(0)=Class'WTF.WTFEquipCombatKnifeFire'
	FireModeClass(1)=Class'WTF.WTFEquipCombatKnifeFireB'
	Description="WTF Berserker: attacks do not slow you, wider damage arc"
	PickupClass=Class'WTF.WTFEquipCombatKnifePickup'
