class WTFEquipFuryFlame extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter2
         ...
         ColorScale(1)=(RelativeTime=0.300000,Color=(B=0,G=0,R=255))
         ColorScale(2)=(RelativeTime=0.667857,Color=(B=0,G=0,R=247,A=255))
         ColorScale(3)=(RelativeTime=1.000000,Color=(B=0,G=0,R=128,A=255))
