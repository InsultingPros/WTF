class WTFEquipM5AR extends M4AssaultRifle
	config(user);

var bool IsWTFCommando;
var WTFEquipM5FmA MyFm;

simulated function PostBeginPlay()
{
	Super.PostBeginPlay();
	MyFm = WTFEquipM5FmA(FireMode[0]);
}
...
defaultproperties
{
	FireModeClass(0)=Class'WTF.WTFEquipM5FmA'
	Description="WTF Commando: toggle to Super Auto"
	PickupClass=Class'WTF.WTFEquipM5Pickup'
	ItemName="M5"
}